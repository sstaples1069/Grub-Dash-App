...
// validation functions: POST/PUT requests
function bodyHasDeliverToProperty(req, res, next) {
  ...
  // pass request body data to the next middleware/handler functions with res.locals
...
// validation function: read, update, and delete requests
...
// validation functions: put/update requests:
...
// validation function: delete request
